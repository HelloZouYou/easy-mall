...
exports.getBannerData = (req, res) => {
    res_data.data = Mock.mock([{
        ...
        {
            id: 2,
            img_url: 'http://localhost:8080/image/banner/2?w=450&h=300',
        },
        {
            id: 3,
...
exports.getCategoryData = (req, res) => {
    res_data.data = Mock.mock([{
        ...
        {
            id: 2,
            icon_url: 'http://localhost:8080/image/category/2?w=30&h=30',
            name: '分类二'
        },
        {
            id: 3,
            icon_url: 'http://localhost:8080/image/category/3?w=30&h=30',
            name: '分类三'
        },
        {
            id: 4,
            icon_url: 'http://localhost:8080/image/category/4?w=30&h=30',
            name: '分类四'
        },
    ])
    res.status(200).json(res_data)
...
exports.getGoodsData = (req, res) => {
    res_data.data = Mock.mock([{
        ...
        id: 2,
        pic_url: 'http://localhost:8080/image/goods/2?w=80&h=80',
        price: 58.0,
        name: '腊豆腐',
        desc: '土家腊豆腐，黄豆磨制，柴火烟熏特色'
    }, {
        id: 3,
        pic_url: 'http://localhost:8080/image/goods/3?w=80&h=80',
        price: 58.0,
        name: '湘西腊肠',
